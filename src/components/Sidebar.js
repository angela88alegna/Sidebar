...
{data.filter((dat)=>{
    ...
    if( searchTerm ==''){
     ...
     else if (dat.delivery_date && dat.delivery_date.toLowerCase().includes(searchTerm.toLowerCase())){
        return dat
    }
    ...
    else if (dat.machine_rejected &&dat.machine_rejected.toLowerCase().includes(searchTerm.toLowerCase())){
        return dat
    }  
